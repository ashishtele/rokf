...
[![Codecov test
coverage](https://codecov.io/gh/ashishtele/rokf/graph/badge.svg)](https://app.codecov.io/gh/ashishtele/rokf)
[![pkgdown](https://github.com/ashishtele/rokf/actions/workflows/pkgdown.yaml/badge.svg)](https://ashishtele.github.io/rokf/)
[![R](https://img.shields.io/badge/R-%3E%3D4.1-blue.svg)](https://www.r-project.org/)
[![License:
MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://ashishtele.github.io/rokf/LICENSE)
[![okf
version](https://img.shields.io/badge/okf-v0.1.2-brightgreen.svg)](https://github.com/okf-memory/okf-agent-memory/releases/tag/v0.1.2)

`rokf` provides a native R interface to **OKF Agent Memory** — a
Git-native persistent memory layer for AI agents built on the [Open
...
OKF Agent Memory solves the fundamental problem that **AI agent
conversations are ephemeral**. When a context window resets,
...
| Function | Purpose |
|----|----|
| [`okf_init()`](https://ashishtele.github.io/rokf/reference/okf_init.md) | Initialize bare OKF v0.2 bundle (`index.md`, `log.md`) |
| [`okf_bootstrap()`](https://ashishtele.github.io/rokf/reference/okf_bootstrap.md) | Scaffold full memory stack into any project |
| [`okf_search()`](https://ashishtele.github.io/rokf/reference/okf_search.md) | BM25 search across concepts (title, desc, tags, body) |
| [`okf_show()`](https://ashishtele.github.io/rokf/reference/okf_show.md) | Full concept: frontmatter, body, inbound/outbound links |
| [`okf_create()`](https://ashishtele.github.io/rokf/reference/okf_create.md) | Create concept + update index.md + append log.md |
| [`okf_update()`](https://ashishtele.github.io/rokf/reference/okf_update.md) | Modify concept + timestamps + log.md |
| [`okf_relate()`](https://ashishtele.github.io/rokf/reference/okf_relate.md) | Link two concepts with context |
| [`okf_validate()`](https://ashishtele.github.io/rokf/reference/okf_validate.md) | Conformance, graph health, provenance, drift, stale gates |
| [`okf_version()`](https://ashishtele.github.io/rokf/reference/okf_version.md) | Get okf binary version |
| [`install_okf()`](https://ashishtele.github.io/rokf/reference/install_okf.md) | Download/update bundled binary |
...
All files are plain Markdown with YAML frontmatter — human-editable,
diffable, reviewable.
...
MIT — see [LICENSE](https://ashishtele.github.io/rokf/LICENSE).

## Links

- [OKF Agent Memory
  (upstream)](https://github.com/okf-memory/okf-agent-memory)
- [OKF v0.2
  Specification](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md)
- [OKF Agent Memory
  Convention](https://github.com/okf-memory/okf-agent-memory/blob/main/docs/CONVENTION.md)
- [Agent Framework Gap blog series](https://ashishtele.github.io) —
  R-native agent architecture deep dives
